...
def test_parse_leden_rijen_iri_en_literal():
    tsv = (
        ...
        '\t"jci..."\t<https://ipalm.nl/bwb/BWBR0004770/artikel/9/lid/1>\t"1"\t"Eerste lid."@nl\n'
        '\t"jci..."\t<https://ipalm.nl/bwb/BWBR0004770/artikel/9/lid/2>\t"2"\t"Tweede met \\"aanhaling\\"."@nl'
    )
    ...
    assert rows[0]["lid"] == "https://ipalm.nl/bwb/BWBR0004770/artikel/9/lid/1"  # IRI afgepeld
