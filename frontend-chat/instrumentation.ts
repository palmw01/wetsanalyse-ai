...
// `fetch` (injecteert W3C-traceparent), zodat één trace de keten chat → graph-qa omspant.
//
...
export async function register(): Promise<void> {
  ...
  registerOTel({ serviceName: process.env.OTEL_SERVICE_NAME || "wetsanalyse-chat" });
}
