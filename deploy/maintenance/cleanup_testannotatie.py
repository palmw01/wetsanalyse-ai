...
async def main():
    ...
    async with httpx.AsyncClient(timeout=30) as client:
        ...
        source_before = await query(source_query)
        ...
        async with db.get_engine().begin() as conn:
            ...
            print(json.dumps({"dry_run": not DO_WRITE, "slug": SLUG, "elementen": 7, "auditregels": audit_count, "beschermd": protected}), flush=True)
            if not DO_WRITE:
